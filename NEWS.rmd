...
BioMonTools_SupportFiles 0.0.1.9129
===========
Released - 2026-09-22

* refactor: Removed original files for NE lake sediment diatom project in favor of FTP

BioMonTools_SupportFiles 0.0.1.9128
===========
Released - 2026-09-17

* refactor: Added initial translator and attribute files for NE lake sediment diatom project
...
* refactor: Added lower boise bug taxa translator file and updated pick file.
...
===========
Released - 2026-06-25
* Updated errors in naming of files for file builder in Great Plains
...
* refactor: Update Great Plains Nebraska Bug Attributes and Taxa Translator
...
* refactor: Added new files and folder for Lower Boise River BCG (fish for now)
...
* refactor: Update Red Lake (MN) fish file
    ...
    + pick list 
* tests: Prefix tests with package name so can run with copy and paste in console
...
* refactor: Update Red Lake (MN) bug attributes, translation, and pick list
...
* refactor: ORWA TaxaTrans revert to "Taxon_orig" due to references in Shiny code
...
* fix: Update MN (Red Lakes) bug taxa translation for odd character
    + Order "Neotaenioglossa\xa0" to "Neotaenioglossa"

BioMonTools_SupportFiles 0.0.1.9049
===========
Released - 2023-12-08

* refactor: Update MN (Red Lakes) bug and fish files (taxa and attributes)
...
* feature: Add dir_results to pick_files
    + Allows for different folders for different calculations in BioMonTools
